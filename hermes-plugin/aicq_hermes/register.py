...
def register(ctx):
    ...
    ctx.register_platform(
        ...
        platform_hint=(
            "You are chatting via AICQ, an end-to-end encrypted chat network. "
...
async def _get_adapter(ctx) -> "AicqPlatformAdapter | None":
    ...
    try:
        ...
        platforms = getattr(ctx, "gateway", {}).get("platforms", {}) if isinstance(getattr(ctx, "gateway", None), dict) else {}
